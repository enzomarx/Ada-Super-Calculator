...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_super_calculator_cli" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#3531bda3#;
   pragma Export (C, u00001, "super_calculator_cliB");
   ...
   u00159 : constant Version_32 := 16#f4adb909#;
   pragma Export (C, u00159, "calculator_operationsB");
   u00160 : constant Version_32 := 16#d92ebaaa#;
   pragma Export (C, u00160, "calculator_operationsS");
   ...
   u00163 : constant Version_32 := 16#61baa04a#;
   pragma Export (C, u00163, "ada__numerics__elementary_functionsS");
   u00164 : constant Version_32 := 16#edf015bc#;
   ...
   u00166 : constant Version_32 := 16#8272e858#;
   ...
   u00168 : constant Version_32 := 16#33fcdf18#;
   ...
   --  calculator_operations%s
   --  calculator_operations%b
   --  super_calculator_cli%b
