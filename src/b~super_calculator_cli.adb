pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~super_calculator_cli.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~super_calculator_cli.adb");
...
package body ada_main is
   ...
   E160 : Short_Integer; pragma Import (Ada, E160, "calculator_operations_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_super_calculator_cli");
...
--  BEGIN Object file/option list
   --   .\calculator_operations.o
   --   .\super_calculator_cli.o
   --   -L.\
